Feature: CAMARA Edge Application Management API, v0.1.0-alpha.1 - Operation createAppDeployment
  ...
  # * At least one edgeCloudZoneId available to deploy the application
  #
  ...
  Background: Common createAppDeployment setup
    ...
    And the resource "/edge-application-management/v0.1alpha1/deployments"
  ...
  Scenario: Invalid Argument. Generic Syntax Exception
    ...
    And the response property "$.message" contains a user friendly text
  @eam_createAppDeployment_400.2_no_request_body
  Scenario: Missing request body
    ...
    And the response property "$.code" is "INVALID_ARGUMENT"
    And the response property "$.message" contains a user friendly text
  @eam_createAppDeployment_400.3_empty_request_body
  ...
  Scenario: Error response for empty property in request body
    ...
    And the response property "$.message" contains a user friendly text
  # Errors 403
  @eam_createAppDeployment_403.1_missing_access_token_scope
