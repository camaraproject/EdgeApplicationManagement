Feature: CAMARA Edge Application Management API, v0.1.0-alpha.1 - Operation deleteAppDeployment
  ...
  Background: Common deleteAppDeployment setup
    ...
    And the resource "/edge-application-management/v0.1alpha1/deployment/{appDeploymentId}"
  ...
  # Errors
  # Error 404
  @eam_deleteAppDeployment_404.1_invalid_parameter
  ...
  # Error 403
  @eam_deleteAppDeployment_403.1_missing_access_token_scope
