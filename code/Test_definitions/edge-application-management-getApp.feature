Feature: CAMARA Edge Application Management API, v0.1.0-alpha.1 - Operation getApp
  ...
  Background: Common getApp setup
    ...
    And the resource "/edge-application-management/v0.1alpha1/apps/{appId}"
  ...
  @eam_getApp_01_generic_success_scenario
  ...
  @eam_getApp_404.1_app_not_found
  ...
  @eam_getApp_403.1_missing_access_token_scope
