Feature: CAMARA Edge Application Management API, v0.1.0-alpha.1 - Operation submitApp
  ...
  Background: Common submitApp setup
    ...
    And the resource "/edge-application-management/v0.1alpha1/apps"
  ...
  # Success scenarios
  @eam_submitApp_01_generic_success_scenario
  ...
  Scenario: Invalid Argument. Generic Syntax Exception
    ...
    And the response property "$.message" contains a user friendly text
  @eam_submitApp_400.2_no_request_body
  Scenario: Missing request body
    ...
    And the response property "$.code" is "INVALID_ARGUMENT"
    And the response property "$.message" contains a user friendly text
  @eam_submitApp_400.3_empty_request_body
  Scenario: Empty object as request body
    ...
    And the response property "$.code" is "INVALID_ARGUMENT"
    And the response property "$.message" contains a user friendly text
  @eam_submitApp_400.4_empty_property
