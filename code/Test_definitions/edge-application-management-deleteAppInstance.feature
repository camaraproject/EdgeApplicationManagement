Feature: CAMARA Edge Application Management API, v0.1.0-alpha.1 - Operation deleteAppInstance
  ...
  Background: Common deleteAppInstance setup
    ...
    And the resource "/edge-application-management/v0.1alpha1/appinstances"
    And the header "Content-Type" is set to "application/json"
    And the header "Authorization" is set to a valid access token
    And the header "x-correlator" complies with the schema at "#/components/schemas/XCorrelator"
  # Success scenarios
  @eam_deleteAppInstance_01_generic_success_scenario_async
  ...
  @eam_deleteAppInstance_02_generic_success_scenario_sync
  ...
  # Errors
  # Error 404
  @eam_deleteAppInstance_404.1_invalid_parameter
  ...
  # Error 403
  @eam_deleteAppInstance_403.1_missing_access_token_scope
