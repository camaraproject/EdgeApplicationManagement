Feature: CAMARA Edge Application Management API, v0.1.0-rc.1 - Operation addEdgeCloudZone
  ...
  Background: Common addEdgeCloudZone setup
    ...
    And the resource "/edge-application-management/v0.1rc1/deployments/{appDeploymentId}/add-edge-cloud-zone"
